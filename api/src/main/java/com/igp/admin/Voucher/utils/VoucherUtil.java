...
public class VoucherUtil {
    ...
    public static boolean createVoucher(VoucherModel voucherModel){
        ...
        try{
            if((voucherModel.getApplicableVoucherType()==1 || voucherModel.getApplicableVoucherType()==2) && voucherModel.getApplicableEmail()!=null){
                ...
                String voucher = generateVoucherCodeFromCustomerName(voucherModel.getApplicableEmail().split(",")[0]);
            ...
            if (status != 0) {
                ...
                preparedStatement.setString(3,voucherModel.getApplicableEmail());
    ...
    public boolean updateVoucher(VoucherModel voucherModel){
        ...
        try{
            ...
            preparedStatement.setString(2,voucherModel.getApplicableEmail());
            preparedStatement.setInt(3,voucherModel.getOrderValue());
            preparedStatement.setString(4,voucherModel.getBlackListPts().toString());
            preparedStatement.setString(5,voucherModel.getWhiteListPts().toString());
