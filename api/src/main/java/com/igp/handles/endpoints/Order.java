...
import com.igp.handles.mappers.Order.OrderMapper;
...
import static com.igp.handles.mappers.Order.OrderMapper.doUpdateOrderProductsStatus;
...
//        Date date1= DateUtils.truncate(dateFormat.parse("2017-01-01"), Calendar.DAY_OF_MONTH);
        ...
        List<com.igp.handles.models.Order.Order> orders=orderMapper.getOrderByStatusDate(scopeId,fkAssociateId,status,date1,
    ...
    public HandleServiceResponse getOrder(@Context HttpServletResponse response,@Context HttpServletRequest request,
        ...
        HandleServiceResponse handleServiceResponse = new HandleServiceResponse();
        OrderMapper orderMapper = new OrderMapper();
        List<com.igp.handles.models.Order.Order> orders = orderMapper.getOrder(scopeId, orderId, fkAssociateId,orderProductIds);
