package com.igp.handles.mappers.Vendor;

import com.igp.handles.models.Vendor.OrderDetailsPerVendor;
    ...
    private boolean checkUniqueUnit(Long orderId,Date deliveryDate,String shippingType,String deliveryTime,Map<String,Set<String>> uniqueUnitsMap){
        ...
        if(shippingType.equalsIgnoreCase("Any time") ||  shippingType.equalsIgnoreCase("Same Day")){
            if(uniqueUnitsMap.containsKey(key)==false){  // simple key not exist so we have to check if that unit can be clubbed or not
                String key1=orderId + "," + deliveryDate + ",Fix Time";
                String key2=orderId + "," + deliveryDate + ",Midnight";
            ...
            String key1=orderId + "," + deliveryDate + ",Any time";
            String key2=orderId + "," + deliveryDate + ",Same Day";
           ...
           // entry.getKey() == past , future , today , tomorrow
            ...
            for (Map.Entry<String, Set<Map<String, String>>> entry1:entry.getValue().entrySet()){
                ...
                for (Map<String,String> map:entry1.getValue()){
                    ...
                    if(childMap.get(timeWhen).get(status).containsKey(orderId)){
